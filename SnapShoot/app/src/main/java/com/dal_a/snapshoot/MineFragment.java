...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (MyRecyclerView) root.findViewById(R.id.mine);
        ...
        mRecyclerView.addOnItemTouchListener(new MyRecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(BaseCardView view, int position) {
                if (view.getTag() instanceof ListCard) {
            ...
            public void onRefresh() {
                new setImages() {
                    ...
                    protected List<BaseCard> doInBackground(Void... params) {
                        List<BaseCard> temps = super.doInBackground();
                        ArrayList<BaseCard> cards = new ArrayList<>();

                        if(!currentUserFacebookID.equals("0")){
                            String userInfo = HttpRequest.get(Constant.MAIN_URL + "/getUserInfo/" + currentUserFacebookID).body();
                            ...
                            artistInformation.setToUserID(currentUserFacebookID);
                            artistInformation.setLayout(R.layout.card_artist);
...
//            String mineData = HttpRequest.get(Constant.MAIN_URL + "/mine/" + currentUserFacebookID + "/" + lastImageTime).body();
...
//            String[] result = userInfo.split("\\*\\*");
//
//            ArtistCard artistInformation = new ArtistCard(getActivity());
//            artistInformation.setName(result[0]);
//            artistInformation.setExplanation(result[1]);
//            artistInformation.setFollows(result[3]);
//            cards.add(artistInformation);
//            cards.addAll(getCard(mineData));
//
//
//            return cards;
//        }
